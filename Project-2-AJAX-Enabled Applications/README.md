...
[Testing code](image-1.png)
And then, when I checked the links and API adress, I've got error message and after exploring this, it seem I have some mismatches in HTML (Cannot set properties of null).
[Catch works!](image-2.png)
